...
Note : 
Si vous avez réussi à utiliser le Vagrantfile pour construire votre machine virtuelle Docker sur VirtualBox, vous pouvez passer directement à l’étape Vérification de l’installation. ## Vérifier que l'installation fonctionne correctement
